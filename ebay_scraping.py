...
def main():
  ...
  product_list_contents = session_requst.get("https://www.ebay.co.uk/sch/musicmagpie/m.html?item=301829202695&hash=item46466c2307%3Ag%3AKAUAAOSwGqpdhZpq&rt=nc&_trksid=p2047675.l2562")
  ...
  for x in range(int(int(result_number)/per_unit)):
    ...
    product_content_page = session_requst.get("https://www.ebay.co.uk/sch/m.html?item=301829202695&hash=item46466c2307%3Ag%3AKAUAAOSwGqpdhZpq&_ssn=musicmagpie&_pgn="+str(x+1)+"&_skc="+str(x*50)+"&rt=nc")
    ...
    for x in range(len(product_lists)):
      ...
      product_page = session_requst.get(product_info[0])
      ...
      description_content_page = session_requst.get(description_page_url)
      ...
      for product_item in product_info:
        ...
        col += 1
        workbook.save("ebay_product_info.xls")
main()
